...
| [command-intent-detection](./command-intent-detection/) | Helps Claude distinguish between requests to display commands vs execute them | **Hook:** SessionStart - Injects guidance for recognizing display intent ("give me the command") vs execute intent ("run the command") |
