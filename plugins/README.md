...
| [file-reference-validation](./file-reference-validation/) | Validates file references in destructive operations to prevent accidental deletion of wrong files when using contextual references | **Hook:** SessionStart - Injects file reference resolution guidance<br>**Hook:** PreToolUse - Validates destructive Bash commands (rm, rmdir, etc.) |
